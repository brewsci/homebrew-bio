class Maker < Formula
  ...
  bottle do
    ...
    sha256 "d86524884088f5fb4a82fc921b4584dc5041a96c7ffc3d8b4eebbe01c464fa41" => :sierra
    sha256 "31081039a26b17a70bd14397e6a9438f872d060fcf08718ec1fcbe66715258f3" => :x86_64_linux
  end
