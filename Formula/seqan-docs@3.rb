class SeqanDocsAT3 < Formula
  ...
  def install
    ...
    # Install documentation into seqan3 and not default path.
    (share/"doc/seqan3").install Dir["#{buildpath}/doc_usr/html"]
  end

  test do
    assert_match "SeqAn3: Welcome", File.read(share/"doc/seqan3/html/index.html")
  end
end
