class Cannoli < Formula
  ...
  url "https://search.maven.org/remotecontent?filepath=org/bdgenomics/cannoli/cannoli-distribution-spark2_2.11/0.6.0/cannoli-distribution-spark2_2.11-0.6.0-bin.tar.gz"
